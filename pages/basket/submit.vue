  ...
  <div v-if="!loading">
    <div class="p-[6%] h-full my-32 lg:my-0">
      ...
      >
        ...
        <div class="flex items-center justify-center sm:mr-0 mr-16  sm:pt-0 pt-20">
          <form class="flex flex-col sm:max-w-[90%] max-w-[155%] " @submit="handleSubmit">
          <input
            type="text"
            :placeholder="$t('BasketInput1')"
            class="text-sm border-2 rounded-lg p-2.5 sm:w-[558px] w-[155%]  mb-[10%]"
          ...
          <input
            ...
            class="text-sm border-2 p-2.5 rounded-lg sm:w-[558px] w-[155%] mb-[10%]"
            :class="phoneClasses"
            v-model="phone"
          ...
          />
            ...
            <button
              type="submit"
              class="font-'Libre Franklin' flex items-center justify-center gap-2 bg-[#323750] text-center text-[#f4f7f8] rounded-lg sm:w-[558px] w-[155%] px-2.5 py-3 text-lg"
            >
              {{ $t("BasketButton2") }}
