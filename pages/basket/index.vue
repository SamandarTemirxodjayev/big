<template>
  <div class="flex items-center flex-col sm:mx-0 -mx-8 my-32">
    <div class="flex items-center justify-between w-[85%]">
      <h1 class="font-medium leading-[36px] not-italic text-[24px] font-'DM Sans'">
        {{ $t("BasketH1") }}
      </h1>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-[25px] w-[85%] sm:py-6 py-4">
      <div class="text-1xl text-[#323750] font-semibold leading-[56px] tracking-[3.34px] " v-if="products.length === 0">
        <span>{{ $t('BasketDivSpan') }}</span></div>
      <div v-for="item in products" :key="item" class="sm:w-full sm:h-full w-[100%] sm:rounded-[12px] rounded-xl" style="
        ...
        <div
          ...
          <div class="sm:space-y-4 space-y-[18px] sm:space-x-0 space-x-10 flex items-center sm:flex-col flex-row">
            ...
            <div class="flex items-center flex-row sm:gap-[12px] gap-3 sm:mr-0 mr-6 justify-center">
              ...
              <span class="text-[18px] not-italic font-'DM Sans' font-medium leading-[27px] text-[#202020]">
    ...
    <div class="w-[85%] h-[1px] flex items-center justify-center sm:my-10 my-4 bg-neutral-400 mx-auto" />
    ...
    <div
      ...
      <div class="flex items-start flex-col gap-3">
        <span class="text-neutral-800 text-lg font-normal leading-[27px] font-'DM Sans'">
          {{ $t("BasketSpan2") }}
        </span>
        <p class="text-neutral-800 text-2xl font-medium font-'DM Sans' leading-[27px]">
